...
export const metadata: Metadata = {
  title: '이용약관',
  description: '유치원맵 노트 웹사이트 이용 조건, 콘텐츠 이용 범위, 정보의 한계를 안내합니다.',
};
    ...
    <main>
      <Container className="static-page">
        ...
        <section>
          <h2>목적</h2>
          <p>
            본 약관은 유치원맵 노트 웹사이트의 이용 조건과 콘텐츠 이용 범위를 안내하기
        ...
        <section>
          <h2>서비스의 범위</h2>
          <p>
            유치원맵 노트는 유치원 선택, 입학 준비, 상담 질문, 통학 동선, 아이 성향에 관한
        ...
        <section>
          <h2>콘텐츠 권리</h2>
          <p>
            사이트에 게시된 글, 이미지, 디자인 요소의 권리는 유치원맵 노트 또는 정당한 권리자에게
